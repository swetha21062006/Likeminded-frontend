        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              onBlur={() => {
                ...
                if (err) setErrors((p) => ({ ...p, businessName: err }));
              }}
              className={`${styles.input} ${errors.businessName ? styles.inputError : formData.businessName && !errors.businessName ? styles.inputSuccess : ""}`}
              placeholder="Your business name"
            />
            {errors.businessName && (
              <p className={styles.fieldError}>⚠ {errors.businessName}</p>
            )}
          </div>
          ...
          <div className={styles.formGroup}>
            <label htmlFor="email" className={styles.label}>
              Business Email <span className={styles.req}>*</span>
            </label>
            <input
              type="email"
              id="email"
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              placeholder="e.g. Retail, F&B, Technology"
            />
          </div>
