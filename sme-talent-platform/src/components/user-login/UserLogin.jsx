  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (msg.includes("no account") || msg.includes("not found")) {
        ...
        setFormError(
          "This email is registered as a Vendor. Please use Vendor Login.",
        );
      } else {
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              className={`${styles.input} ${errors.email ? styles.inputError : email && !errors.email ? styles.inputSuccess : ""}`}
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.passwordWrap}>
              <input
                ...
                className={`${styles.input} ${errors.password ? styles.inputError : password && !errors.password ? styles.inputSuccess : ""}`}
